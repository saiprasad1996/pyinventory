...
class SalesPage:
    ...
    def __init__(self):
        ...
        barcode = Entry(background_label)
        barcode.place(relx=0.25, rely=0.16, relheight=0.07, relwidth=0.46)
        # barcode.configure(background="white")
        barcode.configure(disabledforeground="#a3a3a3")
        barcode.configure(font="TkFixedFont")
        barcode.configure(foreground="#000000")
        barcode.configure(highlightbackground="#d9d9d9")
        barcode.configure(highlightcolor="black")
        barcode.configure(insertbackground="black")
        barcode.configure(selectbackground="#c4c4c4")
        barcode.configure(selectforeground="black")
        barcode.configure(textvariable=self.barcode_text)
